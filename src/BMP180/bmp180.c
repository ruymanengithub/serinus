...
uint BMPreadI2C_2UBytes(i2c_inst_t* I2C_ID, uint8_t reg){
...
int BMPreadI2C_2Bytes(i2c_inst_t* I2C_ID, uint8_t reg){
    // reads an integer
    i2c_write_blocking(I2C_ID, addrBMPwrite, &reg, 1, true);
    uint8_t buffer[2];
    i2c_read_blocking(I2C_ID, addrBMPread, buffer, 2, false);
...
{
    BMP180_CAL cal;
    cal.AC1 = BMPreadI2C_2Bytes(I2C_ID, calregs.AC1);
    cal.AC2 = BMPreadI2C_2Bytes(I2C_ID, calregs.AC2);
    cal.AC3 = BMPreadI2C_2Bytes(I2C_ID, calregs.AC3);
    
    cal.AC4 = BMPreadI2C_2UBytes(I2C_ID, calregs.AC4);
    cal.AC5 = BMPreadI2C_2UBytes(I2C_ID, calregs.AC5);
    cal.AC6 = BMPreadI2C_2UBytes(I2C_ID, calregs.AC6);

    cal.B1 = BMPreadI2C_2Bytes(I2C_ID, calregs.B1);
    cal.B2 = BMPreadI2C_2Bytes(I2C_ID, calregs.B2);
    cal.MB = BMPreadI2C_2Bytes(I2C_ID, calregs.MB);
    cal.MC = BMPreadI2C_2Bytes(I2C_ID, calregs.MC);
    cal.MD = BMPreadI2C_2Bytes(I2C_ID, calregs.MD);
